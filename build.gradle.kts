...
octopusQuality {
    ...
    publication {
        ...
        centralPublications.set(
            setOf(
                ":client|maven|org.octopusden.octopus.reporting-service:client|[jar, jar:javadoc, jar:sources]",
                ":common|maven|org.octopusden.octopus.reporting-service:common|[jar, jar:javadoc, jar:sources]",
                ":reporting-automation|maven|org.octopusden.octopus.reporting-service:reporting-automation|" +
